...
#' 
#' 
#' @format A data frame with 571 observations on the following 40 variables.
#' \describe{
...
#' }
#' 
#' @details Yellowfin Tuna were sampled onboard the vessels by observers of the Inter-American Tropical 
#' Tuna Commission (IATTC, 2004).  Fish were randomly subsampled from purse-seine sets immediately after capture, 
#' and date, position, and sea-surface temperature (SST) were recorded for each set that yielded samples.  Observers 
#' measured fork length of the fish, removed samples of white muscle tissue from the dorsal musculature adjacent
