...
#' 
#' @format 
#' A data frame with 660 observations on the following 13 variables.
#' \describe{
...
#' \item{\code{Length}}{Predator length in mm}
#' \item{\code{Fullness}}{Visual estimate of YFT stomach fullness, expressed as a percentage}
#' \item{\code{W}}{Case weights}
#' \item{\code{Group}}{Prey Group. A factor with levels \code{Argonautidae} 
#' \code{Exocoetidae} \code{Galatheidae} \code{Hemiramphidae} \code{Myctophidae} 
#' \code{Nomeidae} \code{Ommastrephidae} \code{Ostraciidae} \code{Phosichthyidae} 
#' \code{Portunidae} \code{Scombridae} \code{Tetraodontidae}}
#' }    
#' 
#' @details 
