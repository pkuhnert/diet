...
\alias{yftISO}
\docType{data}
\title{Yellowfin Tuna isotope dataset
%%   ~~ data name/kind ... ~~
}
...
\format{
  ...
  \describe{
    \item{\code{IsoSampNo}}{Unique, nonrepeating number for each isotope sample taken from an individual YFT or several YFT aggregated into a composite sample }
    ...
    \deqn{\delta X = ([R_{sample}/R_{standard}]-1)\times 1000}
    where X is \eqn{^{15}N} or \eqn{^{13}C}, and \eqn{R_{sample}} and \eqn{R_{standard}} 
    are the corresponding ratios of heavy to light isotopes (\eqn{^{15}N/^{14}N} or \eqn{^{14}C/^{13}C}) 
    in the sample and standard, respectively. 
    \eqn{R_{standard}} for \eqn{\delta^{15}N} was atmospheric \eqn{N_2} and for \eqn{\delta^{13}C} 
    was the Peedee Belemnite (PDB) limestone formation.}
    }
}
\details{YFT were sampled onboard the vessels by observers of the Inter-American Tropical Tuna Commission (IATTC, 2004).  
